    ...
    public partial class FormMain : Form
    {
        ...
        private void tvMenu_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            switch (tag)
            {
                ...
                case "1-73":
                    {
                        _1_073.UCMain ucMain = new _1_073.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-74":
                    {
                        _1_074.UCMain ucMain = new _1_074.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-75":
                    {
                        _1_075.UCMain ucMain = new _1_075.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-76":
                    {
                        _1_076.UCMain ucMain = new _1_076.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-77":
                    {
                        _1_077.UCMain ucMain = new _1_077.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-78":
                    {
                        _1_078.UCMain ucMain = new _1_078.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-79":
                    {
                        _1_079.UCMain ucMain = new _1_079.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-80":
                    {
                        _1_080.UCMain ucMain = new _1_080.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-81":
                    {
                        _1_081.UCMain ucMain = new _1_081.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-82":
                    {
                        _1_082.UCMain ucMain = new _1_082.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-83":
                    {
                        _1_083.UCMain ucMain = new _1_083.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-84":
                    {
                        _1_084.UCMain ucMain = new _1_084.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-85":
                    {
                        _1_085.UCMain ucMain = new _1_085.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-86":
                    {
                        _1_086.UCMain ucMain = new _1_086.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-87":
                    {
                        _1_087.UCMain ucMain = new _1_087.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-88":
                    {
                        _1_088.UCMain ucMain = new _1_088.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-89":
                    {
                        _1_089.UCMain ucMain = new _1_089.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-90":
                    {
                        _1_090.UCMain ucMain = new _1_090.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-91":
                    {
                        _1_091.UCMain ucMain = new _1_091.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-92":
                    {
                        _1_092.UCMain ucMain = new _1_092.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-93":
                    {
                        _1_093.UCMain ucMain = new _1_093.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-94":
                    {
                        _1_094.UCMain ucMain = new _1_094.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-95":
                    {
                        _1_095.UCMain ucMain = new _1_095.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-96":
                    {
                        _1_096.UCMain ucMain = new _1_096.UCMain();
                        AddTab(ucMain, node);
                    }
                    break;
                case "1-97":
